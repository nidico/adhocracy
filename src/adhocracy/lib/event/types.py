...
T_USER_CREATE = EventType(
    ...
    link_path=lambda e: h.entity_url(e.user, absolute=True),
...
T_INSTANCE_EDIT = EventType(
    ...
    link_path=lambda e: h.entity_url(e.instance, absolute=True),
...
T_INSTANCE_DELETE = EventType(
    ...
    link_path=lambda e: h.base_url(instance=None, absolute=True),
...
T_PROPOSAL_CREATE = EventType(
    ...
    link_path=lambda e: h.entity_url(e.proposal, absolute=True),
...
T_PAGE_CREATE = EventType(
    ...
    link_path=lambda e: h.entity_url(e.page, absolute=True),
...
T_DELEGATION_CREATE = EventType(
    ...
    subject=lambda: _(u"New Delegation: %(user)s delegated "
                      "%(scope)s to %(agent)s"),
    link_path=lambda e: h.entity_url(e.delegation, absolute=True),
...
T_VOTE_CAST = EventType(
    ...
    link_path=lambda e: h.entity_url(e.poll.subject, absolute=True),
...
T_SELECT_VARIANT = EventType(
    ...
    link_path=lambda e: h.entity_url(e.poll.selection, absolute=True),
    event_msg=lambda: _(u"%(vote)s %(poll)s"))
...
N_DELEGATION_RECEIVED = NotificationType(
    ...
    link_path=lambda e: h.entity_url(e.scope, absolute=True))
